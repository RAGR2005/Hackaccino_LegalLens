        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-4xl font-bold">About Legal Lens</h1>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-xl section-text leading-relaxed mb-6">
                Legal Lens is a pioneering platform designed to bridge the gap between complex legal systems and
          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="section-text">support@legallens.com</span>
              </div>
              <div className="flex items-center gap-3">
