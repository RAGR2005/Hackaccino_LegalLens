          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg section-text max-w-2xl mx-auto">
                Legal Lens provides powerful tools to help you navigate the legal system efficiently
              </p>
            </div>
          ...
          <div className="container mx-auto">
            <div className="grid gap-12 md:grid-cols-2 items-center">
              <div>
                ...
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6">Benefits of Legal Lens</h2>
