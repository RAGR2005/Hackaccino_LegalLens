        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg section-text">Get help with Legal Lens services and features</p>
            </motion.div>
                        ...
                        <CardContent className="space-y-6">
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="section-text">support@legallens.com</p>
                  ...
                  >
                    <Card className="dark:bg-black/50">
                      <CardHeader>
                        ...
                        <CardDescription className="section-text">
                          Find answers to common questions about Legal Lens
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                          {[
                            ...
                            },
                            {
                              ...
                              answer:
                                "Yes, the online FIR filing through Legal Lens is legally valid. We work in coordination with local police departments to ensure that your FIR is properly registered. You will receive an official FIR number and confirmation once your report is processed by the relevant police station.",
                            },
                            {
                            ...
                            },
                            {
                              ...
                              answer:
                                'Yes, you can track the status of your FIR through your Legal Lens account dashboard. Simply log in and navigate to the "My FIRs" section where you can view real-time updates on your filed reports.',
                            },
                            {
                      ...
                      <CardContent>
                        ...
                        >
                          ...
                          <div className="grid gap-4 md:grid-cols-2">
                            {[
                              { title: "How to Use Legal Lens", duration: "5:32" },
