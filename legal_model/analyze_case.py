...
def analyze_case(case_text):
    ...
    try:
        ...
        # Self-defense special case
        if "self-defense" in case_text_lower or "self defense" in case_text_lower:
        ...
        if override_section:
            print(f"Special case detected. Overriding prediction from {section} to {override_section}")
        ...
        # Get explanation for this section
...
def main():
    ...
    while True:
        ...
        # Use the final section (which may be overridden)
