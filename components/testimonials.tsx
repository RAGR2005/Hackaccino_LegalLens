...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    review:
      "Legal Lens helped me understand the relevant IPC sections for my property dispute case. The AI prediction was spot on and saved me hours of research!",
  },
  {
    id: 2,
    name: "Rahul Verma",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg section-text max-w-2xl mx-auto">
            Hear from people who have used Legal Lens to navigate their legal challenges
          </p>
        </div>
